#!/usr/bin/env bash
# ============================================================================
# Scout Agent · v3.28.2 · 总包(完整替代;plist/verify 保护;自检自跑;落地后自归档一份进仓)
...
cp -f "$SELF_PATH" "./scout_agent_install_v3_28_2.sh" 2>/dev/null && echo "[install] 安装脚本已归档 ./scout_agent_install_v3_28_2.sh" || true
echo ""; echo "✓ Scout Agent v3.28.2: $(pwd) — 首跑 python3 scout_agent.py --mode morning;门禁 python3 verify_scout_deploy.py"
