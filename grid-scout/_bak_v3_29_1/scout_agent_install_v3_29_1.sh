#!/usr/bin/env bash
# ============================================================================
# Scout Agent · v3.29.1 · 总包(完整替代;plist/verify 保护;自检自跑;落地后自归档一份进仓)
...
# Scout Agent v3.29.1(DS 决策官 · 三班制 + 六因子核 + 准入闸 + 自算趋势榜 + 仓位档/Kelly)
...
cp -f "$SELF_PATH" "./scout_agent_install_v3_29_1.sh" 2>/dev/null && echo "[install] 安装脚本已归档 ./scout_agent_install_v3_29_1.sh" || true
echo ""; echo "✓ Scout Agent v3.29.1: $(pwd) — 首跑 python3 scout_agent.py --mode morning;门禁 python3 verify_scout_deploy.py"
