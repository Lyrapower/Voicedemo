...
echo "=== 1/4 LM Studio plugin → demo/aster ==="
...
echo "=== 2/4 LaunchAgents (KeepAlive: 8501 gateway + 8787 Aster) ==="
bash "${ROOT}/scripts/garden/install_launchagents.sh"

echo "=== 3/4 Port + health ==="
...
echo "=== 4/4 Fingerprint regression ==="
...
echo "DONE — repo at ${ROOT}; gateway/8787 should survive reboot (LaunchAgent KeepAlive)."
