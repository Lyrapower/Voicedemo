...
def main():
    with tempfile.TemporaryDirectory() as td:
        ...
        sess=s.create_session(agent_id="local-main",channel="grid",title="Local Resident")
        ...
        j=s.create_job(channel="grid",goal="smoke",worker="local",
        ...
        assert Supervisor._parse_escalation(
            '{"action":"escalate","target":"fast","reason":"x"}'
        )["target"]=="fast"
